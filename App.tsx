...
import PluginsManagerScreen from "@/screens/PluginsManagerScreen";
...
export default function App() {
  ...
  useEffect(() => {
    BuiltinPlugins.forEach(plugin => {
      ...
      store.install(plugin.manifest.id);
      if (plugin.manifest.safe) {
        store.enable(plugin.manifest.id);
      }
    });
  }, []);
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Tab.Screen name="Plugins" component={PluginsManagerScreen} options={{ tabBarLabel: '插件' }} />
